...
import com.carmaxbackend.admin.brand.BrandRepository;
...
//		Category wheels = new Category(20);
//		Brand enkei = new Brand("Mishimoto");
//		enkei.getCategories().add(wheels);
//
//		Brand savedBrand = repo.save(enkei);
//
